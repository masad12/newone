...
from testingprojectofme import Testingprojectofme, AsyncTestingprojectofme, APIResponseValidationError
from testingprojectofme._types import Omit
from testingprojectofme._models import BaseModel, FinalRequestOptions
from testingprojectofme._exceptions import (
    APIStatusError,
    APITimeoutError,
    TestingprojectofmeError,
    APIResponseValidationError,
)
from testingprojectofme._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: Testingprojectofme | AsyncTestingprojectofme) -> int:
...
class TestTestingprojectofme:
    client = Testingprojectofme(base_url=base_url, api_key=api_key, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "testingprojectofme/_legacy_response.py",
                        "testingprojectofme/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "testingprojectofme/_compat.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(TestingprojectofmeError):
            with update_env(**{"PETSTORE_API_KEY": Omit()}):
                client2 = Testingprojectofme(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: Testingprojectofme) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(TESTINGPROJECTOFME_BASE_URL="http://localhost:5000/from/env"):
            client = Testingprojectofme(api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: Testingprojectofme) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Testingprojectofme) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Testingprojectofme) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Testingprojectofme(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Testingprojectofme(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    @mock.patch("testingprojectofme._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: Testingprojectofme) -> None:
    ...
    @mock.patch("testingprojectofme._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: Testingprojectofme) -> None:
    ...
    def test_omit_retry_count_header(
        self, client: Testingprojectofme, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncTestingprojectofme:
    client = AsyncTestingprojectofme(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_copy_default_headers(self) -> None:
        client = AsyncTestingprojectofme(
            base_url=base_url, api_key=api_key, _strict_response_validation=True, default_headers={"X-Foo": "bar"}
        )
        assert client.default_headers["X-Foo"] == "bar"
    ...
    def test_default_headers_option(self) -> None:
        ...
        client2 = AsyncTestingprojectofme(
            base_url=base_url,
            api_key=api_key,
            _strict_response_validation=True,
            default_headers={
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(TestingprojectofmeError):
            with update_env(**{"PETSTORE_API_KEY": Omit()}):
                client2 = AsyncTestingprojectofme(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncTestingprojectofme) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(TESTINGPROJECTOFME_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncTestingprojectofme(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncTestingprojectofme) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncTestingprojectofme) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncTestingprojectofme) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncTestingprojectofme(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncTestingprojectofme(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_retrying_timeout_errors_doesnt_leak(
        self, respx_mock: MockRouter, async_client: AsyncTestingprojectofme
    ) -> None:
        respx_mock.get("/store/inventory").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    async def test_retries_taken(
        self,
        async_client: AsyncTestingprojectofme,
        failures_before_success: int,
        failure_mode: Literal["status", "exception"],
        respx_mock: MockRouter,
    ) -> None:
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncTestingprojectofme, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    def test_get_platform(self) -> None:
        ...
        from testingprojectofme._utils import asyncify
        from testingprojectofme._base_client import get_platform
